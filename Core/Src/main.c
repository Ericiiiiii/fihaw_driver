...
static void MX_ADC3_Init(void)
{
  ...
  */
  ...
  LL_ADC_SetChannelSingleDiff(ADC3, LL_ADC_CHANNEL_11, LL_ADC_SINGLE_ENDED);
...
static void MX_SPI4_Init(void)
{
  ...
  */
  ...
  /* SPI4_RX Init */
  LL_DMA_SetPeriphRequest(DMA1, LL_DMA_STREAM_7, LL_DMAMUX1_REQ_SPI4_RX);
...
static void MX_SPI5_Init(void)
{
  ...
  */
  ...
  /* SPI5_RX Init */
  LL_DMA_SetPeriphRequest(DMA2, LL_DMA_STREAM_0, LL_DMAMUX1_REQ_SPI5_RX);
  ...
  /* SPI5_TX Init */
  LL_DMA_SetPeriphRequest(DMA2, LL_DMA_STREAM_1, LL_DMAMUX1_REQ_SPI5_TX);
...
static void MX_TIM12_Init(void)
{
  ...
  */
  ...
  LL_TIM_IC_SetFilter(TIM12, LL_TIM_CHANNEL_CH1, LL_TIM_IC_FILTER_FDIV1);
  LL_TIM_IC_SetPolarity(TIM12, LL_TIM_CHANNEL_CH1, LL_TIM_IC_POLARITY_RISING);
...
static void MX_UART8_Init(void)
{
  ...
  */
  ...
  /* UART8_RX Init */
  LL_DMA_SetPeriphRequest(DMA1, LL_DMA_STREAM_4, LL_DMAMUX1_REQ_UART8_RX);
  ...
  /* UART8_TX Init */
  LL_DMA_SetPeriphRequest(DMA1, LL_DMA_STREAM_5, LL_DMAMUX1_REQ_UART8_TX);
...
static void MX_USART2_UART_Init(void)
{
  ...
  PD3   ------> USART2_CTS
  */
  GPIO_InitStruct.Pin = LL_GPIO_PIN_5|LL_GPIO_PIN_4|LL_GPIO_PIN_6|LL_GPIO_PIN_3;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
...
static void MX_USART6_UART_Init(void)
{
  ...
  PG8   ------> USART6_RTS
  */
  GPIO_InitStruct.Pin = LL_GPIO_PIN_9|LL_GPIO_PIN_15|LL_GPIO_PIN_14|LL_GPIO_PIN_8;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOI, GPIO_nLED_GREEN_Pin|SPI6_CS2_MS5611_Pin|SPI6_CS1_ICM20649_Pin);

  /**/
  LL_GPIO_ResetOutputPin(GPIOG, SPI4_CS3_MS5611_CS_Pin|SPI1_CS3_ICM20689_Pin);

  /**/
  LL_GPIO_ResetOutputPin(HEATER_GPIO_Port, HEATER_Pin);

  /**/
  LL_GPIO_ResetOutputPin(GPIOF, SPI2_CS2_RM3100_Pin|SPI4_CS1_BMI088_A_Pin|SPI2_CS1_FRAM_Pin|SPI4_CS2_BMI088_G_Pin
                          |SPI1_CS1_ADI16470_Pin);

  /**/
  LL_GPIO_SetOutputPin(GPIOI, GPIO_nLED_RED_Pin|GPIO_nLED_BLUE_Pin);

  /**/
  GPIO_InitStruct.Pin = GPIO_nLED_GREEN_Pin|GPIO_nLED_RED_Pin|GPIO_nLED_BLUE_Pin;
  ...
  /**/
  GPIO_InitStruct.Pin = SPI4_CS3_MS5611_CS_Pin|SPI1_CS3_ICM20689_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  ...
  /**/
  GPIO_InitStruct.Pin = SPI6_CS2_MS5611_Pin|SPI6_CS1_ICM20649_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  ...
  /**/
  GPIO_InitStruct.Pin = SPI2_CS2_RM3100_Pin|SPI4_CS1_BMI088_A_Pin|SPI2_CS1_FRAM_Pin|SPI4_CS2_BMI088_G_Pin
                          |SPI1_CS1_ADI16470_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
